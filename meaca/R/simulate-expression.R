...
#' @param delta  a vector of length num_gene, representing DE effect for each gene
#' @param case   which correlation structure to simulate data from (see simulation setup in the paper)
...
#'
#' @title Simulate expression data. 
#' @param obj  object returned by \link{\code{prepare_simulation}}.
