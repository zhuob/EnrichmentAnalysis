...
\newcommand{\genr}{geneSetTest-rank}
...
%	\OurMethod~...
%	CAMERA incorporates a VIF in their set-level statistics to account for inflation due to the presence of between-gene correlation. \OurMethod is closely related to their approach in that set-level statistic in (REF)    
...
\begin{figure*}[!th]
	...
	\includegraphics[width=15cm,height=4cm]{Figures/parallel_b.eps}
	\includegraphics[width=15cm,height=4cm]{Figures/parallel_c.eps}
	\includegraphics[width=15cm,height=4cm]{Figures/parallel_d.eps}
