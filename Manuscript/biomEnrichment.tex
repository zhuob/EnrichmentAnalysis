...
\begin{document}
	...
	relies on the assumption that correlation between any two local statistics are almost the same as
	...
	\dfrac{1}{n_1}\sum_{i: X_i=0}\epsilon_{ij}.
	\end{equation}
...
%	statistics. MRSGE is also known as the rank version of \gent~\citep{wu2012camera}. 
	...
	the type I error. As to power, we set DE probability according to each of alternative scenarios
	...
	the neuroprotective effects of IGF-1. They also showed that AKT is altered in Huntington’s disease
	patients.  
