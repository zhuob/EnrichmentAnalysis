	...
	\end{table}
		...
		\end{longtable}
		 	...
		 	\begin{figure}[H]
		 		...
		 		\begin{center}
		 			\includegraphics[width=5cm,height=5cm]{Figures/log10P_Camera.eps}
		 			\includegraphics[width=5cm,height=5cm]{Figures/log10P_GSEA.eps}
		 			\includegraphics[width=5cm,height=5cm]{Figures/log10P_GSEA_CAMERA.eps}
		 		\end{center} 
		 	\end{figure} 
