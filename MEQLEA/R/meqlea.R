...
#' meqlea for single gene set test.
#'
#' @title MEQLEA-single. 
...
#####  our test
meqlea_single <- function(expression_data, trt, go_term, standardize=F){
...
#' meqlea for testing multiple gene sets.
#'
#' @title MEQLEA-multiple. 
#' @param expression_data  the expressoin matrix.
#' @param trt  treatment labels.
...
meqlea_multiple <- function(expression_data, trt, geneset, standardize = T, minSetSize = 5, fdr_method = "BH"){
