...
gset <- readGeneSet("/Users/Bin/Google Drive/Study/Thesis/Correlation/Packages/GSEA-P-R/GeneSetDatabases/C1.gmt")
...
CLS <- GSEA.ReadClsFile(file="/Users/Bin/Google Drive/Study/Thesis/Correlation/Packages/GSEA-P-R/Datasets/Gender.cls")
dataset <- GSEA.Gct2Frame2(filename = "/Users/Bin/Google Drive/Study/Thesis/Correlation/Packages/GSEA-P-R/Datasets/Gender.gct")

AAA <- GSEA(dataset, CLS, gs.db = "/Users/Bin/Google Drive/Study/Thesis/Correlation/Packages/GSEA-P-R/GeneSetDatabases/C1.gmt",
            #  Program parameters :----------------------------------------------------------------------------------------------------------------------------
            ...
            gs.size.threshold.min = 5,     # I changed this         # Minimum size (in genes) for database gene sets to be considered (default: 25)
...
######################
#  This returns two data frames: one has positive ES and the other has negative ES
#######################
abc <- GSEA(                                                                      # Input/Output Files :-------------------------------------------
 input.ds =  "/Users/Bin/Google Drive/Study/Thesis/Correlation/Packages/GSEA-P-R/Datasets/Gender.gct",               # Input gene expression Affy dataset file in RES or GCT format
 input.cls = "/Users/Bin/Google Drive/Study/Thesis/Correlation/Packages/GSEA-P-R/Datasets/Gender.cls",               # Input class vector (phenotype) file in CLS format
 gs.db =     "/Users/Bin/Google Drive/Study/Thesis/Correlation/Packages/GSEA-P-R/GeneSetDatabases/C1.gmt",           # Gene set database in GMT format
 output.directory      = "/Users/Bin/Google Drive/Study/Thesis/Correlation/Packages/GSEA-P-R/StudyGSEA/",            # Directory where to store output and results (default: "")
 #  Program parameters :----------------------------------------------------------------------------------------------------------------------------
 doc.string            = "Gender_C1",     # Documentation string used as a prefix to name result files (default: "GSEA.analysis")
 non.interactive.run   = F,               # Run in interactive (i.e. R GUI) or batch (R command line) mode (default: F)
 reshuffling.type      = "sample.labels", # Type of permutation reshuffling: "sample.labels" or "gene.labels" (default: "sample.labels" 
